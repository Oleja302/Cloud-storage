    ...
    public partial class MainWindow : MaterialForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < fileNames.Count; i++)
            {
                ...
                socket.Send(System.IO.File.ReadAllBytes(pathFiles[i]));
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            while (allReceiveBytes != bytesMap.Sum())
            {
                ...
                {
                    using (BinaryWriter writer = new BinaryWriter(System.IO.File.Open(fullPath, FileMode.OpenOrCreate)))
                    {
        ...
        public static void CreateShortcut()
        {
            ...
            IWshShortcut Shortcut = (IWshShortcut)wshShell.CreateShortcut(@$"C:\Users\{Environment.UserName}\AppData\Roaming\Microsoft\Windows\SendTo\Synnefo.lnk");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            pathToExecutable = pathToExecutable.Remove(pathToExecutable.Length - 1);
            ...
            if (currentDir != pathToExecutable)
